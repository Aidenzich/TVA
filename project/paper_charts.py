...
def exp_length() -> None:
    ...
    plot_scores("Length", "NDCG@10", param_values, beauty, toys, ml_1m).show()
...
def exp_dropout() -> None:
    ...
    plot_scores(
        "Dropout", "NDCG@10", param_values, beauty, toys, ml_1m, ax1_ylim_min=0.13
    ).show()
...
def exp_layers() -> None:
    ...
    plt = plot_scores(
        "Layers", "NDCG@10", param_values, beauty, toys, ml_1m, ax1_ylim_min=0.13
    )
